...
export const organizations: Organization[] = [
  ...
  org("dso", "DSO", "Agência de operações de segurança", "Resident Evil 6 (2012)", "Responder a ameaças bioterroristas.", "Organização de Leon e Sherry em RE6.", ["re6-2012", "vendetta"], ["games-canon", "cgi-canon"], "Canon dos jogos/CGI."),
