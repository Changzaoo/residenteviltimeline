...
export const locations: Location[] = [
  ...
  loc("wrenwood", "Wrenwood Hotel", "Próximo às ruínas de Raccoon City", "Resident Evil Requiem (2026)", ["re-requiem-2026"], "Local recente associado a Grace Ashcroft em material de Requiem.", ["games-canon"], "Canon dos jogos; detalhes recentes devem ser conferidos.", ["capcom-requiem", "capcom-portal", "re-fandom"])
];
